...
def process_pic(path: str, ):
    ...
    im_resized_100_500 = im.resize((1000, 500))
    im_resized_200_100 = im.resize((200, 100))
    im_resized_100_500.save(f'static/images/resized_1000_500{im_path.name}')
    im_resized_200_100.save(f'static/images/resized_200_100{im_path.name}')
